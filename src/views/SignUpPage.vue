  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="flex justify-center">
        <div class="absolute top-[207px] w-[365px] h-[431px] rounded-xl shadow flex flex-col justify-center items-center">
          <div class="flex flex-col gap-3">
            <!-- first button -->
            <div class="w-[312px] h-[48px] rounded-lg border-[2px] border-blue-900 flex justify-center items-center">
            ...
            <!--Mobile  number -->
            <div class="w-[312px] h-[48px] rounded-lg border-[3px] border-blue-900 flex justify-start items-center gap-3">
              <div class="w-[50px] h-[48px] rounded-lg border-r-[2px] border-blue-900 text-blue-800 flex justify-center items-center text-[15px]">
                +91
              </div>
            ...
            <!-- GENERATE OTP-->
            <div class="w-[312px] h-[48px] rounded-lg border-[2px] bg-blue-700 border-blue-900 flex justify-center items-center">
