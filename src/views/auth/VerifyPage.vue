          ...
          <div class="w-full px-6 py-8 space-y-4">
            ...
            <div class="w-full space-y-4">
              <div class="w-full text-center ">
                ...
                <p class="text-sm font-medium text-blue-700 mt-1">OTP has been sent to xxxx91</p>
              </div>

              <!-- phone -->
              <div class="w-full">
                <input type="text" id="input-group-1" class="w-full bg-white border-2 border-blue-800 text-gray-900 text-sm rounded-lg focus:ring-blue-200 block px-5 p-2.5 focus:outline-none focus:ring-4 placeholder-blue-800" placeholder="Enter OTP">
              </div>

              <button type="button" v-on:click.prevent="verifyOtp" class="w-full text-white bg-blue-800 disabled:bg-blue-600 font-semibold rounded-lg px-5 py-4 focus:outline-none uppercase inline-flex items-center justify-center gap-2" :disabled="loading">
