          ...
          <div class="w-full bg-white max-w-sm rounded-xl shadow-md">
            <div class="w-full p-6 space-y-4">
              ...
              <div class="w-full space-y-4">
                ...
                <button type="button" class="w-full text-white bg-blue-800 focus:bg-blue-900 font-semibold rounded-lg px-5 py-4 focus:outline-none uppercase">Get Started</button>
              </div>
