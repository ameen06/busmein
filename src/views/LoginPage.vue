    ...
    <ion-page>
      <ion-content :fullscreen="true">
        <div class="flex justify-center">
          <div
            class="absolute top-[207px] w-[365px] h-[431px] rounded-xl  shadow flex  flex-col justify-center items-center"
          >
            <div class="flex flex-col gap-3 ">
              <!-- first button -->
              <div
                class=" w-[312px] h-[48px] rounded-lg border-[2px] border-blue-900 flex justify-center items-center"
              > <div class="w-[157px] h-[45px] flex justify-center items-center">
                  <p class="font-[700] text-[20px] text-blue-800">SIGN UP</p>
                </div>
                <div
                  class="w-[157px] h-[47px] bg-blue-800 rounded-lg flex justify-center items-center"
                >
                  <p class="font-[700] text-[20px] text-white">LOGIN</p>
                </div>
               
              </div>
              <!--Mobile  number -->
              <div
                class=" w-[312px] h-[48px] rounded-lg border-[3px] border-blue-900 flex justify-start items-center gap-3 "
              >
              <div class="w-[50px] h-[48px] rounded-lg border-r-[2px]  border-blue-900 text-blue-800 flex justify-center items-center text-[15px]"> +91</div>
              <p class="font-[600] text-[12px] text-blue-800">Enter your Mobile Number</p>
            </div>
               <!-- OTP -->
               <div
                class=" w-[312px] h-[48px] rounded-lg border-[3px] border-blue-900 flex justify-start items-center gap-5 p-4"
              >
            <div class="w-[27px] h-[26px] border-[3px] border-blue-800 rounded-lg flex justify-center items-center text-blue-800 font-[600]">2</div>
            <div class="w-[27px] h-[26px] border-[3px] border-blue-800 rounded-lg flex justify-center items-center text-blue-800 font-[600]">4</div>
            <div class="w-[27px] h-[26px] border-[3px] border-blue-800 rounded-lg flex justify-center items-center text-blue-800 font-[600]">1</div>
            <div class="w-[27px] h-[26px] border-[3px] border-blue-800 rounded-lg flex justify-center items-center text-blue-800 font-[600]">5</div>
            <div class="w-[27px] h-[26px] border-[3px] border-blue-800 rounded-lg flex justify-center items-center text-blue-800 font-[600]"></div>
            <div class="w-[27px] h-[26px] border-[3px] border-blue-800 rounded-lg flex justify-center items-center text-blue-800 font-[600]"></div>
            </div>
              <!-- get started -->
              <div
                class=" w-[312px] h-[48px] rounded-lg border-[2px] bg-blue-700 border-blue-900 flex justify-center items-center"
              >
                <p class="font-[700] text-[20px] text-white">GENERATE OTP</p>
              </div>
            </div>
  
           <div class="mt-3">
            <div class="w-full flex justify-center items-center">
              <p class=" text-blue-800">OR</p>
            </div>
            <!-- google facebook apple login-->
            <div
              class="w-full gap-2 flex justify-center items-center"
            >
              <div
                class="h-[52px] w-[52px] border-2 border-blue-900 rounded-full flex justify-center items-center"
              >
                <svg
              ...
              >
                <svg
                  ...
                  height="36"
                  viewBox="0 0 24 24"
                  style="fill: rgba(49, 111, 246, 1); transform: ; msfilter: "
                >
                  <path
          ...
          <!-- nav floating bar -->
          <div
            class="absolute top-[755px] w-[240px] h-[50px] rounded-full bg-blue-800 shadow-md"
          >
      ...
      C375.874,334.702,378.973,337.798,378.973,341.62z"
              ...
              <div
                class="flex justify-center items-center w-[100px] h-[40px] rounded-full bg-white mr-2"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  ...
                  style="fill: rgba(2, 35, 185, 1); transform: ; msfilter: "
                >
                  <path
                    d="M12 2a5 5 0 1 0 5 5 5 5 0 0 0-5-5zm0 8a3 3 0 1 1 3-3 3 3 0 0 1-3 3zm9 11v-1a7 7 0 0 0-7-7h-4a7 7 0 0 0-7 7v1h2v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1z"
                  ></path>
                </svg>
                <p class="text-blue-800">User</p>
              </div>
            </div>
          </div>
        </div>
