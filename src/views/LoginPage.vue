  ...
  <ion-page>
    <ion-content :fullscreen="true">
      <div class="flex justify-center">
        <div class="absolute top-[204px] w-[365px] h-[431px] rounded-xl shadow">
          <div class="flex justify-center">
            <!-- first button -->
            <div class="absolute top-[28px] w-[312px] h-[48px] rounded-lg border-[2px] border-blue-900 flex justify-center items-center">
              <div class="w-[157px] h-[47px] bg-blue-800 rounded-lg flex justify-center items-center">
                <p class="font-[700] text-[20px] text-white">SIGN UP</p>
              </div>
              <div class="w-[157px] h-[45px] flex justify-center items-center">
                <p class="font-[700] text-[20px] text-blue-800">LOGIN</p>
              </div>
            </div>
            <!-- Second button -->
            <div class="absolute top-[87px] w-[312px] h-[48px] rounded-lg border-[2px] border-blue-900 flex justify-start items-center gap-2 p-2">
              <svg
              ...
              <p class="font-[600] text-[12px] text-blue-800">
                Enter Your Full Name
              </p>
            </div>
            <!-- third button -->
            <div class="absolute top-[146px] w-[312px] h-[48px] rounded-lg border-[2px] border-blue-900 flex justify-start items-center gap-2 p-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
            ...
            <!-- fourth button -->
            <div class="absolute top-[205px] w-[312px] h-[48px] rounded-lg border-[2px] border-blue-900 flex justify-start items-center gap-2 p-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
            ...
            <!-- get started -->
            <div class="absolute top-[264px] w-[312px] h-[48px] rounded-lg border-[2px] bg-blue-700 border-blue-900 flex justify-center items-center">
              <p class="font-[700] text-[20px] text-white">GET STARTED</p>
            </div>
          </div>
          <div class="w-full flex justify-center">
            <p class="absolute top-[332px] text-blue-800">OR</p>
          </div>
          <!-- google facebook apple login-->
          <div class="absolute top-[361px] w-full gap-2 flex justify-center items-center">
            <div class="h-[52px] w-[52px] border-2 border-blue-900 rounded-full flex justify-center items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="36"
                height="36"
        ...
        <!-- nav floating bar -->
        <div class="absolute top-[755px] w-[240px] h-[50px] rounded-full bg-blue-800 shadow-md">
	...
	C375.874,334.702,378.973,337.798,378.973,341.62z"
            ...
            <div class="flex justify-center items-center w-[100px] h-[40px] rounded-full bg-white mr-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="19"
